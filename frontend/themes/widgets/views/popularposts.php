<?php
/* @var $popularPosts frontend\models\News */
...
<div class="list_vertical">
    <section class="accordation_menu">
        <div>
            ...
            <label for="label-1" id="item1"><i class="ferme"> </i>Popular Posts<i class="icon-plus-sign i-right1"></i><i
                        ...
                        <div class="popular-post-grids">
                            <?php foreach ($popularPosts as $popularPost) { ?>
                                <div class="popular-post-grid">
                                    <div class="post-img">
                                        <a href="/news/view?id=<?= $popularPost->id ?>"><img src="/uploads/news/<?= $popularPost->image ?>" alt=""/></a>
                                    </div>
                                    <div class="post-text">
                                        <a class="pp-title" href="/news/view?id=<?= $popularPost->id ?>"> <?= $popularPost->title ?></a>
                                        <p><?= $popularPost->date ?>
                                            <a class="span_link" href="#">
                                                <span class="glyphicon glyphicon-comment"></span><?= $commentModel->getNumberOfCommentsByNewsId($popularPost->id) ?> </a>
                                            <a class="span_link" href="#">
                                                <span class="glyphicon glyphicon-eye-open"></span><?= $popularPost->views ?> </a></p>
                                    </div>
                    ...
                    <div class="force-overflow">
                        <div class="popular-post-grids">
                            ...
                            <div class="popular-post-grid">
                                ...
                                <div class="post-text">
                                    <a class="pp-title" href="single.html"> Lorem Ipsum is simply dummy text
                                        printing</a>
                        ...
                        <div class="response">
                            <div class="media response-info">
                                <div class="media-left response-text-left">
                                    <a href="#">
                                        <img class="media-object" src="/template/images/icon1.png" alt=""/>
                                    </a>
